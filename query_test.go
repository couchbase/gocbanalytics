...
func TestDispatchTimeout(t *testing.T) {
	...
	t.Run("Cluster Timeout", func(tt *testing.T) {
		...
		runTest(context.Background(), tt, cluster, cbanalytics.ErrTimeout)
	})
	...
	t.Run("Scope Timeout", func(tt *testing.T) {
		...
		runTest(context.Background(), tt, cluster.Database(TestOpts.Database).Scope(TestOpts.Scope), cbanalytics.ErrTimeout)
	})
}
